...
urlpatterns = [
    ...
    path('news/', views.news, name='news_info'),
    ...
    path('editor/update/competitions/<int:pk>/', views.editor_update_competitions, name='editor_update_competitions'),
    path('editor/delete/competitions/<int:pk>/', views.editor_delete_competitions, name='editor_delete_competitions'),
    path('editor/update/news/<int:pk>/', views.editor_update_news, name='editor_update_news'),
